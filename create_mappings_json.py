...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_dir", default="/homes/es314/xml_and_images_only")
    parser.add_argument("--mapping_output_path", default="/import/c4dm-05/elona/doremi_v5_half/train_validation_test_records/mapping.json")
