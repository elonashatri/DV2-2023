...
open_files = '/homes/es314/xml_and_images_only/*/xml_by_page/*.xml'
...
for xmlfiles in glob.glob(open_files):
    ...
    for page in pages:
        ...
        #parsed_page_file = open('/homes/es314/DOREMI_version_2/xml_parsed/Parsed_' + filename + '_Page_' + str(page_number) +'.xml', 'w')        
    ...
    allfiles_stats_file = open('/homes/es314/DV2-2023/classnames.csv', 'w')
